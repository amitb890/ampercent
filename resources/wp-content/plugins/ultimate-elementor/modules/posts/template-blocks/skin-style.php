...
abstract class Skin_Style {
	 ...
	 *
	 * @param array $query array of posts.
	 *
	 * @since 1.7.0
	 * @access public
	 */
	public function get_header( $query ) {
	 ...
	 * @access public
	 */
	public function get_filter_values( $query ) {
		...
		$taxs = get_terms( $filter_by, array( 'object_ids' => $post_ids ) );
	 ...
	 * @access public
	 */
	public function render_filters( $query ) {
		...
		$filters = $this->get_filter_values( $query );
	...
	public function render( $style, $settings, $node_id ) {
		...
		<div class="uael-post__header">
			<?php $this->get_header( self::$query->posts ); ?>
		</div>
