<?php
function previoust_post_short() { 
	$prev_post = get_previous_post();
	$next_post = get_next_post();
	if ( ! empty( $prev_post ) ){ ?>
	<div class="read-next">
		<div class="featured-thum">
			<?php $prevthumbnail = get_the_post_thumbnail($prev_post->ID); ?>
				<?php previous_post_link('%link', $prevthumbnail); ?>
		</div>
		<a href="<?php echo get_permalink( $prev_post->ID ); ?>">
		<div class="re-pv-heading">
	...
	<?php } 
		...
		<div class="read-next">
		<div class="featured-thum">
			<?php $nextthumbnail = get_the_post_thumbnail($next_post->ID); ?>
...
// register shortcode
add_shortcode('resourcepv', 'previoust_post_short'); 
/**
